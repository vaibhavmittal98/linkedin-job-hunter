...
def _build_system_prompt(cv_text: str, title: str = "", company: str = "", description: str = "") -> str:
    ...
    parts = [
        ...
        "",
        "CONTENT:",
        "- Anchor the answer in the JOB DESCRIPTION. Start from what THIS role needs and the problems it's trying to solve, then show how the candidate would contribute to those specific needs. The emphasis is forward-looking (what I can add here), not a backward-looking summary of past jobs.",
        "- Do NOT recite or summarize the whole CV. Pick only the 1-2 experiences most relevant to THIS job's requirements and use them as evidence for how you'd help. Leave everything else out.",
        "- Map experience to the role's actual responsibilities. For each point, the reader should see: this is what the job needs, and here's how I'd deliver it based on what I've done.",
