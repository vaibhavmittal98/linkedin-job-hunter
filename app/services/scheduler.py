...
def add_scrape_schedule(job_id: str, hour: int, minute: int, keywords: list[str], locations: list[str], max_results: int, scrape_all: bool, published_at: str, cv_text: str, frequency: str = "daily", day_of_week: str = "mon", user_id: int = None, job_type: str = ""):
    ...
    scheduler.add_job(
        ...
        trigger=trigger,
        id=job_id,
        args=[keywords, locations, max_results, scrape_all, published_at, cv_text, job_id, user_id, job_type],
